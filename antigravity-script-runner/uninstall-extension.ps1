<#
.SYNOPSIS
    IDE 擴充套件一鍵卸載腳本 (智慧偵測 Cursor、VS Code、Antigravity IDE + 清理 Junction 與註冊紀錄)
#>
...
$extName = "antigravity-script-runner"
$extVersion = "1.6.1"
$displayName = $extName
...
Write-Host "  解除安裝 IDE 原生擴充套件 (Cursor / VS Code / Antigravity)" -ForegroundColor Cyan
