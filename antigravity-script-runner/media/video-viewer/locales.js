...
(function (root) {
  const LOCALES = {
    'zh-TW': {
      ...
      player_close_title: '關閉播放器並回到資料夾畫廊 (Esc / 右鍵)',
      ...
      toast_reveal_in_gallery: '已在資料夾畫廊中定位：{file}',
      toast_expanded_gallery: '已切換為資料夾畫廊模式',
    ...
    'en': {
      ...
      player_close_title: 'Close player and return to folder gallery (Esc / Right-click)',
      ...
      toast_reveal_in_gallery: 'Located in folder gallery: {file}',
      toast_expanded_gallery: 'Switched to folder gallery mode',
