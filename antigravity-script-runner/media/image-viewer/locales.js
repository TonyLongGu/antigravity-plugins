...
(function (root) {
  const LOCALES = {
    'zh-TW': {
      ...
      lightbox_close_title: '關閉檢視器並回到資料夾畫廊 (Esc / 右鍵)',
      lightbox_expand_gallery_title: '展開為資料夾畫廊 (G)',
      ...
      toast_reveal_in_gallery: '已在資料夾畫廊中定位：{name}',
    ...
    'en': {
      ...
      lightbox_close_title: 'Close viewer and return to folder gallery (Esc / Right Click)',
      lightbox_expand_gallery_title: 'Expand to folder gallery (G)',
      ...
      toast_reveal_in_gallery: 'Located in folder gallery: {name}',
